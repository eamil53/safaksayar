...
import { ChevronDown, MessageSquare, HelpCircle, Mail, Phone, MapPin } from 'lucide-react';
    ...
    <>
      ...
      <div className="container support-container animate-fade-in">
        <div className="support-header">
          ...
          <h1 className="hero-title" style={{ fontSize: '48px', marginTop: '12px' }}>Size Nasıl Yardımcı Olabiliriz?</h1>
          <p className="hero-desc" style={{ margin: '16px auto 0 auto' }}>
            Şafak Sayar uygulaması ile ilgili aklınıza takılan soruların yanıtlarını bulun veya destek ekibimizle iletişime geçin.
          </p>
        </div>
        ...
        <div style={{ marginBottom: '80px' }}>
          {activeTab === 'faq' ? (
            ...
            <div className="calc-grid">
              ...
              <div style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '24px', padding: '20px' }}>
                <h4 style={{ fontSize: '20px', fontFamily: 'var(--font-heading)' }}>Diğer İletişim Kanalları</h4>
                <p style={{ color: 'var(--text-secondary)', fontSize: '15px' }}>
                  Aşağıdaki kanallardan da bize ulaşabilirsiniz. Hafta içi mesai saatleri içerisinde gönderilen taleplere genellikle 24 saat içinde dönüş sağlanır.
                </p>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div>
                      <div style={{ fontSize: '12px', color: 'var(--text-muted)' }}>E-posta</div>
                      <a href="mailto:destek@safaksayar2026.com" style={{ fontSize: '15px', fontWeight: '600' }}>destek@safaksayar2026.com</a>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div>
                      <div style={{ fontSize: '12px', color: 'var(--text-muted)' }}>Geliştirici Web Sitesi</div>
                      <a href="https://safaksayar2026.com" target="_blank" rel="noreferrer" style={{ fontSize: '15px', fontWeight: '600' }}>safaksayar2026.com</a>
                    </div>
                  </div>
                </div>
              </div>
